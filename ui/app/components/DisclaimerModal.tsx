...
const DISCLAIMER_STATE_KEY = `pp-disclaimer-${appConfig.app.version}`;
  ...
  return (
    <div
      style={{
        ...
        padding: "24px",
        animation: "pp-disclaimer-fadein 0.25s ease",
      }}
    >
      <style>{`
        @keyframes pp-disclaimer-fadein {
          from { opacity: 0; }
          to { opacity: 1; }
        }
        @keyframes pp-disclaimer-slidein {
      ...
      <div
        style={{
          ...
          animation: "pp-disclaimer-slidein 0.3s cubic-bezier(0.34, 1.2, 0.64, 1)",
          overflow: "hidden",
        }}
      >
        {/* Header */}
        ...
        <div style={{ padding: "28px 32px" }}>
          ...
          <a
            href="https://github.com/TechShady/pattern-problem-app"
            target="_blank"
          ...
          >
            ...
            github.com/TechShady/pattern-problem-app
          </a>
          <p
            style={{
              margin: "0 0 28px",
